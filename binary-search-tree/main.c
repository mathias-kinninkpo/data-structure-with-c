...
PNoeud creationNoeud(int obj,PNoeud fgauche,PNoeud fdroit)
{
...
PNoeud creationFeuille(int obj)
{
    return creationNoeud(obj,NULL, NULL);
}

int renvoyerNoeud(PNoeud noeud)
{
    return noeud->valeur;
}
...
int rechercheBinaire(PNoeud n,int valeur)
{
    if (n != NULL)
    {
